    ...
    >
      ...
      <div className="grid grid-cols-1 gap-y-3 justify-items-center mt-10 ml-5 ">
        <p className="text-5xl font-bold">
          A NEW ERA: MESSAGE FROM THE RCL TEAM
        </p>
        ...
        <p className="p-3 text-left text-[18px]">
          ...
          <br />
          <br />
          Introducing the RCL Website! Your one stop destination for all the
          latest news and headlines across both Champions League and Redemption
          League. Be sure to stop by throughout the season as we'll be constanly
