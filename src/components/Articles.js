  ...
  return (
    <div className="min-h-screen bg-[url('images/bgpng.png')] ">
      <div className="flex flex-col md:grid grid-cols-4 justify-items-center">
        ...
        <div className="hidden md:flex flex-col items-center justify-center text-center polls text-[black] rounded-[10px] bg-[#eaecee] h-[400px] p-[10px] shadow-md shadow-black sticky top-5 w-3/4 mt-5">
